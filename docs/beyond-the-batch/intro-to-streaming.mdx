...
<ul>
  <li>
    Stateless - processing stream of events without maintaining any state or
    knowledge of previous events. Example:
    <ul>
      <li>
  ...
  <li>
    Statelful - processing stream of events and maintaining state or knowledge
    of previous events. Examples:
    <ul>
      <li>
