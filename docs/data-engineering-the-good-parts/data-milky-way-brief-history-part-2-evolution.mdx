...
![Latency numbers every programmer should know](./assets/latency_numbers.png) (Source: https://twitter.com/srigi/status/917998817051541504)


**Bonus content**: 24 minute video version of Latency in Big Data (demonstrates the massive impact of using memory vs disk vs network in Big Data):
<div style={{textAlign: 'center'}}>
